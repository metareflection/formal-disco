...
def system_reflect() -> str:
    return (
        ...
        "4. Optionally: propose a NEW HEURISTIC if you see a pattern that none of\n"
        "   the current heuristics capture\n\n"
        "Output format:\n"
        ...
        "  TAGS: ...\n"
        "  ---\n\n"
        "If proposing a new heuristic, end with:\n"
        "  NEW_HEURISTIC_NAME: name\n"
        "  NEW_HEURISTIC_KIND: concept or conjecture\n"
        "  NEW_HEURISTIC_TEMPLATE: the prompt template text\n"
    )
